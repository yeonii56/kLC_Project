namespace RoomBuildingStarterKit.BuildSystem
{
    ...
    public class GroundFurnitureEntity : FurnitureEntityBase
    {
        ...
        public GroundFurnitureEntity(FloorEntity floorEntity, List<FloorEntity> floorEntities, short direction, FurnitureType furnitureType, GameObject furniture, FurnitureCustomPersistentProperties customProperties) : base(furnitureType, furniture, direction, floorEntity, customProperties)
        {
            this.FloorEntities = floorEntities;
        }
